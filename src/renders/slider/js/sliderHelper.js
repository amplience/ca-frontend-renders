window.loryHelpers = {
    navigationDots: function ($sliderBox, sliderInstance, sliderSettings) {
        ...
        var dots = Array.prototype.slice.call($sliderBox.querySelectorAll('.js_ca_slider_dot'), 0);
    ...
    disableNavButtons: function ($sliderBox, sliderInstance) {
        var $slides = Array.prototype.slice.call($sliderBox.querySelectorAll('.js_ca_slide'), 0);
